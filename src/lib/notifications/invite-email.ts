...
<body style="font-family: sans-serif; max-width: 480px; margin: 0 auto; padding: 24px; color: #27272a;">
  <h2 style="font-size: 18px; font-weight: 600; margin-bottom: 12px;">You're invited to ${orgName}</h2>
  <p style="font-size: 14px; line-height: 1.6; margin-bottom: 16px;">
    <strong>${invitedByName}</strong> has invited you to join <strong>${orgName}</strong> on HalalFlow — an Islamic finance workflow approval platform.
  </p>
  <a href="${inviteUrl}" style="display: inline-block; background: #059669; color: #fff; text-decoration: none; font-size: 14px; font-weight: 500; padding: 10px 20px; border-radius: 8px;">
    Accept Invitation
  </a>
