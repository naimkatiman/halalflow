...
export const en = {
  ...
  auth: {
    signIn: "Sign in",
    signInWelcome: "Welcome back to your workspace",
    email: "Email",
    password: "Password",
    ...
    createWelcome: "Start managing workflows with your team",
    fullName: "Full name",
    orgName: "Organization name",
    orgHint: "Creates your workspace. Leave blank to set up later.",
  ...
  dashboard: {
    ...
    templates: "Templates",
    templatesDefined: "workflow templates defined",
